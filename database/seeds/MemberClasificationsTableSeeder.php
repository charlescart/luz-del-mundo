...
class MemberClasificationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $clasifications = [
            ...
            ['id' => 4, 'name' => 'Jefe de Obrero', 'description' => 'Pastor jefe de obreros'],
            ['id' => 5, 'name' => 'Pro Templo', 'description' => 'Integrante de la organizacion de protemplo'],
            ['id' => 6, 'name' => 'Miembro', 'description' => 'Integrante de la iglesia'],
        ];
