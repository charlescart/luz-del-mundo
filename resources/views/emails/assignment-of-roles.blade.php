                        ...
                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:0px; padding-right: 10px; padding-left: 0px;">
                            ...
                            <div style="color:#111111;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:30px;padding-right:20px;padding-bottom:5px;padding-left:20px;">
                                <div style="font-size: 12px; line-height: 14px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; color: #111111;">
                                    <p style="font-size: 14px; line-height: 16px; text-align: left; margin: 0;"><span style="color: #a17c44; font-size: 14px; line-height: 16px;"><span style="font-size: 26px; line-height: 31px;">Nuevos Roles Asignados!</span></span></p>
                                </div>
                            </div>
                            <!--[if mso]>
                            </td>
                            ...
                            <div style="color:#888888;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:180%;padding-top:10px;padding-right:20px;padding-bottom:10px;padding-left:20px;">
                                <div style="font-size: 12px; line-height: 21px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; color: #888888;">
                                    <p style="font-size: 12px; line-height: 23px; text-align: justify; margin: 0;"><span style="color: #ffffff; font-size: 13px; mso-ansi-font-size: 14px;">Hola <strong>{{explode(" ", $user->name)[0]}}</strong>, te escribo para informarte que se te han asignado nuevos roles en la plataforma, esto te permitirá tener privilegios adicionales a los comunes en el sistema y acceso a funcionalidades nuevas, los roles que se te han asignado son en la calidad de:</span></p>
                                    <ul>
                                    ...
                                    <p style="font-size: 12px; line-height: 23px; text-align: justify; margin: 0;"><span style="color: #ffffff; font-size: 13px; mso-ansi-font-size: 14px;">Te invitamos a <strong>Iniciar Sesión</strong> en nuestra plataforma y empezar a disfrutar de tus nuevos privilegios en el sistema.</span></p>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                    <tr>
                                        <td style="padding-top: 15px; padding-right: 30px; padding-bottom: 30px; padding-left: 30px" align="left">
                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{url('login')}}" style="height:31.5pt; width:78pt; v-text-anchor:middle;" arcsize="0%" stroke="false" fillcolor="#A17C44">
                                                <w:anchorlock/>
                                                <v:textbox inset="0,0,0,0">
                                                    <center style="color:#000000; font-family:Tahoma, Verdana, sans-serif; font-size:14px">
                                <![endif]-->
                                <a href="{{url('/login')}}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #000000; background-color: #A17C44; border-radius: 0px; -webkit-border-radius: 0px; -moz-border-radius: 0px; width: auto; width: auto; border-top: 1px solid #A17C44; border-right: 1px solid #A17C44; border-bottom: 1px solid #A17C44; border-left: 1px solid #A17C44; padding-top: 5px; padding-bottom: 5px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;">
                                            <span style="font-size: 16px; line-height: 32px;"><span style="font-size: 14px; line-height: 28px;">INICIAR SESIÓN!</span></span>
                                            </span></a>
                                <!--[if mso]>
                                </center>
                                </v:textbox>
