<table role="presentation" cellpadding="0" cellspacing="0" style="background:#3685B6;font-size:0px;width:100%;" border="0">
    <tbody>
    <tr>
        <td>
                        ...
                        <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:9px 0px 9px 0px;">
                            ...
                            <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;">
                                <table role="presentation" cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0">
                                    <tbody>
                                    <tr>
                                        <td style="word-wrap:break-word;font-size:0px;padding:15px 0px 0px 0px;" align="center">
                                            <div style="cursor:auto;color:#FFFFFF;font-family:Lato, Tahoma, sans-serif;font-size:14px;line-height:22px;text-align:center;">
                                                <h1 style="font-family: 'Cabin', sans-serif; color: #FFFFFF; font-size: 32px; line-height: 100%; margin-bottom: 0px;">Luz del Mundo</h1>
                                                <p style="margin: 0px 0px 13px 0px;">Barcelona, Mision 31</p>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
