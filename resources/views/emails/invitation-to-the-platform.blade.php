                                    ...
                                    <tr>
                                        <td style="word-wrap:break-word;font-size:0px;padding:0px 1px 0px 0px;" align="center">
                                            <div style="cursor:auto;color:#FFFFFF;font-family:Roboto, Tahoma, sans-serif;font-size:14px;line-height:22px;text-align:center;">
                                                <h1 style="font-family: 'Cabin', sans-serif; color: #FFFFFF; font-size: 32px; line-height: 100%;"><span style="color:#4e5f70;">Bienvenido Charles!</span></h1>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="word-wrap:break-word;font-size:0px;padding:0px 10px 25px 10px;" align="justify">
                                            <div style="cursor:auto;color:#000000;font-family:Roboto, Tahoma, sans-serif;font-size:11px;line-height:1.5;text-align:justify;">
                                                <p><span style="font-size:14px;"><span style="color:#2c3e50;">Hola&nbsp;Charles, te damos la&nbsp;bienvenida&nbsp;al sistema de gestion impulsada por la Iglesia Luz del Mundo 31.&nbsp;Irma Torrealba&nbsp;te ha sugerido para formar parte de su equipo en calidad de Pro-Templo, de estar interesado en formar parte de la plataforma y del equipo de Irma Torrealba&nbsp;te invitamos a dar clic en el boton&nbsp;Unirme Ahora&nbsp;y seguir las instrucciones. Dios te bendiga y que te siga llevando de victoria en victoria!</span></span></p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="word-wrap:break-word;font-size:0px;padding:1px 0px 37px 0px;" align="center">
                                            <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;width:auto;" align="center" border="0">
                                                <tbody>
                                                <tr>
                                                    <td style="border:none;border-radius:24px;color:#fff;cursor:auto;padding:12px 36px;" align="center" valign="middle" bgcolor="#275877"><a href="https://google.com/charlesrodriguez" style="text-decoration:none;background:#275877;color:#fff;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;text-transform:none;margin:0px;" target="_blank">Unirme Ahora</a></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </td>
