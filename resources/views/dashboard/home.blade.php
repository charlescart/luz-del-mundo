...
@section('content')
    ...
    <header class="page-header p-2">
        <div class="container-fluid">
            <span class="p-0 lead">Dashboard</span>
        </div>
    </header>
                ...
                <div class="col-lg-4">
                    <div class="client card">
                        ...
                        <div class="card-body text-center">
                            <div class="client-avatar"><img src="{{ Avatar::create(Auth::user()->name)->toBase64() }}"
                                                            alt="..."
                ...
                <div class="col-lg-6">
                    <div class="articles card">
                        ...
                        <div class="card-body no-padding">
                            ...
                            <div class="item d-flex align-items-center">
                                <div class="image"><img src="{{ Avatar::create(Auth::user()->name)->toBase64() }}"
                            ...
                            <div class="item">
                                <div class="feed d-flex justify-content-between">
                                    <div class="feed-body d-flex justify-content-between"><a href="#"
                                                ...
                                                src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" alt="person"
                                ...
                                <div class="feed d-flex justify-content-between">
                                    <div class="feed-body d-flex justify-content-between">
                                        <a href="#" class="feed-profile">
                                            <img src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" alt="person"
                                                 class="img-fluid rounded-circle">
                                        </a>
                                        <div class="content">
